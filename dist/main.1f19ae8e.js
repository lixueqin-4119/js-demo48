...
var view = {
  ...
  init: function init(container) {
    view.el = (0, _jquery.default)(container); //接收的el会被作为容器
  ...
  render: function render(n) {
    ...
    (0, _jquery.default)(view.html.replace('{{n}}', n)).prependTo(view.el);
  },
  events: {
    'click #add1': 'add1',
    'click #minus1 ': 'minus1',
  ...
  autoBindEvents: function autoBindEvents() {
    for (var key in view.events) {
      ...
      var part1 = key.slice(0, spaceIndex + 1);
...
var view = {
  ...
  x: function x(e) {
    var index = parseInt(e.currentTarget.dataset.index); //用DOM做标记
...
if (active) {
  //active=true如果点击了就增加active,      点击就存储当前的值
